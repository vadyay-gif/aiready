...
class _ScenarioCompleteScreenState extends State<ScenarioCompleteScreen> {
  bool get _isTrack1Lesson1 =>
      widget.trackIndex == 0 && widget.lessonIndex == 0;

  /// Guided T1 L1 scenario 1 only: unlock copy (non-guided uses combined challenge result screen).
  bool get _showT1l1NextScenarioUnlocked =>
      _isTrack1Lesson1 && widget.scenarioIndex == 0;
            ...
            child: ValueListenableBuilder<GuidedOnboardingStep>(
              ...
              builder: (context, currentStepEnum, _) {
                ...
                children: [
                  ...
                  if (_showT1l1NextScenarioUnlocked) ...[
                    const SizedBox(height: 8),
                    Text(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(_anotherScenarioCtaLabel),
                    ),
                  ),
                ],
              ),
  ...
  String get _anotherScenarioCtaLabel {
    if (_isTrack1Lesson1 && widget.scenarioIndex == 0) {
      return 'Go to Scenario 2';
    }
