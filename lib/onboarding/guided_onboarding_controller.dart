...
class GuidedOnboardingController {
  /// Master switch: when false, no in-app guided tour (overlays, coach marks, step gating).
  /// Intro carousel and normal navigation are unchanged.
  static const bool guidedTourEnabled = false;
  ...
  static bool get isActive => guidedTourEnabled && _active;
  ...
  static int? getCurrentStepNumber({int? scenarioSectionIndex, bool settingsPage = false}) {
    if (!guidedTourEnabled || !_active) return null;
  ...
  static String? getUIActionHint(int? stepNumber) {
    ...
    switch (stepNumber) {
      ...
      case 11:
        // Guided onboarding step 11 is ScenarioScreen before the Lesson 1 challenge (button: Try the Challenge).
        return "Tap 'Try the Challenge' to continue.";
      case 16:
